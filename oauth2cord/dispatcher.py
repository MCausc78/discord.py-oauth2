...
class Dispatcher:
    """A mixin to implement oauth2cord.py event system.
    ...
    def _schedule_event(
        ...
        **kwargs: Any,
        ...
        # Schedules the task
        return self.loop.create_task(wrapped, name=f'oauth2cord.py: {event_name}')
    ...
    async def on_error(self, event_method: str, /, *args: Any, **kwargs: Any) -> None:
        ...
        Check :func:`~oauth2cord.on_error` for more details.
