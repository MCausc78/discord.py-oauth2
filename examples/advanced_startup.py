...
import asyncpg  # asyncpg is not a dependency of the discord_slayer_sdk.py, and is only included here for illustrative purposes.
...
class CustomBot(commands.Bot):
    ...
    async def setup_hook(self) -> None:
        ...
        if self.testing_guild_id:
            guild = discord_slayer_sdk.Object(self.testing_guild_id)
...
async def main():
    ...
    handler = logging.handlers.RotatingFileHandler(
        filename='discord_slayer_sdk.log',
        encoding='utf-8',
    ...
    # discord_slayer_sdk.utils.setup_logging(handler=handler, root=False)
