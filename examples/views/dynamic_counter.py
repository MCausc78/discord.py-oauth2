...
class DynamicCounter(
    slaycord.ui.DynamicItem[slaycord.ui.Button],
    ...
    @property
    def style(self) -> slaycord.ButtonStyle:
        if self.count < 10:
            return slaycord.ButtonStyle.grey
        if self.count < 15:
            return slaycord.ButtonStyle.red
        if self.count < 20:
            return slaycord.ButtonStyle.blurple
        return slaycord.ButtonStyle.green
