...
class DynamicCounter(
    oauth2cord.ui.DynamicItem[oauth2cord.ui.Button],
    ...
    @property
    def style(self) -> oauth2cord.ButtonStyle:
        if self.count < 10:
            return oauth2cord.ButtonStyle.grey
        if self.count < 15:
            return oauth2cord.ButtonStyle.red
        if self.count < 20:
            return oauth2cord.ButtonStyle.blurple
        return oauth2cord.ButtonStyle.green
